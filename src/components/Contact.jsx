...
const contactDetails = [
  {
    ...
    label: "Email",
    value: "My@email.com",
    href: "mailto:sakeerhussain.s123@gmail.com",
  },
  {
            ...
            <div className="relative bg-gray-900/70 backdrop-blur-lg border border-indigo-500/20 rounded-2xl p-8 group-hover:border-indigo-500/40 transition-all duration-300">
              <form ref={form} onSubmit={sendEmail} className="flex flex-col gap-4">
                ...
                <button
                  ...
                  className="mt-1 p-3 rounded-lg bg-gradient-to-r from-cyan-500 to-indigo-600 hover:from-cyan-400 hover:to-indigo-500 text-white font-semibold text-sm transition-all duration-300 hover:scale-[1.02] active:scale-[0.98] disabled:opacity-60 disabled:cursor-not-allowed disabled:scale-100"
                >
